...
const AuthCallbackPage = lazy(() => named(import('@/pages/auth/AuthCallbackPage'), 'AuthCallbackPage'));
...
const VideoSlotPage = lazy(() => named(import('@/pages/casino/VideoSlotPage'), 'VideoSlotPage'));
...
const RafflePage = lazy(() => named(import('@/pages/RafflePage'), 'RafflePage'));
      ...
      <Routes>
        <Route element={<AppLayout />}>
          ...
          <Route element={<RequireAuth />}>
            ...
            <Route path="casino/fortuna" element={<VideoSlotPage />} />
